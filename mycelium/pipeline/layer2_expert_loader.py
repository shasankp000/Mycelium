...
with open(os.path.join(_DUMMY_MODELS, 'Medical', 'svm_model_medical.pkl'), 'rb') as f:
    medical_model = pickle.load(f)
with open(os.path.join(_DUMMY_MODELS, 'Medical', 'vectorizer_medical.pkl'), 'rb') as f:
    medical_vectorizer = pickle.load(f)

with open(os.path.join(_DUMMY_MODELS, 'Music', 'svm_model_music.pkl'), 'rb') as f:
    music_model = pickle.load(f)
with open(os.path.join(_DUMMY_MODELS, 'Music', 'vectorizer_music.pkl'), 'rb') as f:
    music_vectorizer = pickle.load(f)

with open(os.path.join(_DUMMY_MODELS, 'Physics', 'svm_model_physics.pkl'), 'rb') as f:
    physics_model = pickle.load(f)
with open(os.path.join(_DUMMY_MODELS, 'Physics', 'vectorizer_physics.pkl'), 'rb') as f:
